...
| Phase | Status | Notes |
|---|---|---|
| 0 — Foundation, Design System, Security Baseline | **In progress** | PR-0.1 monorepo+infra ✅, PR-0.2 db+RLS ✅, PR-0.4 web+ui+i18n ✅, PR-0.3 Express API + PR-0.5 Auth.js + PR-0.6 CI remaining |
