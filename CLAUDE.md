...
Current phase: **Phase 1 — Tenant, RBAC, Settings, Onboarding Wizard** (PR-1.1 general settings + PR-1.2 branding + PR-1.3 members & roles + PR-1.4 API keys shipped).
...
| 1 — Tenant, RBAC, Settings, Onboarding | **In progress** | PR-1.1 general settings ✅; PR-1.2 branding ✅; PR-1.3 members & roles ✅; PR-1.4 API keys (create with show-once secret, scopes, expiry, revoke, audit-logged) ✅; PR-1.5 onboarding wizard remaining |
