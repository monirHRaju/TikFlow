...
Current phase: **Phase 1 — Tenant, RBAC, Settings, Onboarding Wizard** (PR-1.1 general settings + PR-1.2 branding + PR-1.3 members & roles shipped).
...
| 1 — Tenant, RBAC, Settings, Onboarding | **In progress** | PR-1.1 general settings ✅; PR-1.2 branding ✅; PR-1.3 members & roles (list, add member with initial password, edit roles, suspend/reactivate, last-owner guard, self-suspend guard) ✅; PR-1.4 API keys, PR-1.5 onboarding wizard remaining |
